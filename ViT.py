...
train_dataset = torchvision.datasets.CIFAR100(root='./data10', train=True, download=True, transform=transform)
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=32, shuffle=True, num_workers=2)

test_dataset = torchvision.datasets.CIFAR100(root='./data10', train=False, download=True, transform=transform)
...
for epoch in range(num_epochs):
    ...
    torch.save(model, ('/home/u802098/KubaStuff/epochsLarge_100/%i')%epoch)
...
with torch.no_grad():
    for data in test_loader:
        ...
        # Get predictions and update correct count
